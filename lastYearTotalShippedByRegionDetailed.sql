select 
	...
	--[InvcDtl].[ProdCode] as [ProdCode],
	[ProdGrup].[Description] as [Description],
	sum([InvcDtl].[OurShipQty]) as [Qty],
...
group by [SalesRep].[RepReportsTo],[ProdGrup].[Description]