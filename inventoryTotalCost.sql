select
	sum((( PartCost.StdLaborCost + PartCost.StdBurdenCost + PartCost.StdMaterialCost + PartCost.StdSubContCost + PartCost.FIFOAvgLaborCost + PartCost.FIFOAvgBurdenCost + PartCost.FIFOAvgMaterialCost + PartCost.FIFOAvgMtlBurCost )  * PartWhse.OnHandQty)) as [Total_Inventory_Cost]
