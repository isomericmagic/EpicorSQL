...
where (YEAR(Customer.EstDate) = YEAR(GETDATE())) AND (Part.PartNum !='NULL') AND (Part.PartNum != 'NON COMPLIANCE') AND (Part.PartNum != 'VOLUME REBATE') AND (Part.PartNum != 'CO-OP') AND [SalesRep].[RepReportsTo] = 'WEST'
